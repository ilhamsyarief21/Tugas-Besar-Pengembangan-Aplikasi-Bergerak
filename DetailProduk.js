...
import { View, Text, TouchableOpacity, handlePress,Image } from 'react-native';
  ...
  return (
    ...
    <FontAwesome
      ...
      <Image
        ...
        <Text style={{ fontFamily: 'raleway-regular', position: 'absolute', top: '50%', color: 'white', top: 190, left: 80, marginTop: 137  }}>6 Bedroom</Text>
        <Text style={{ fontFamily: 'raleway-regular', position: 'absolute', top: '50%', color: 'white', top: 189, left: 192, marginTop: 137  }}>4 Bathroom</Text>
